  ...
  return (
    <>
          ...
          <div className="absolute w-full lg:h-200 h-100 inset-0 bg-[#00000099] flex items-center justify-center ">
            ...
            <div className='lg:w-26.25 w-20 bg-[linear-gradient(to_right,#fff_37%,#D9176C_37%)]  absolute right-0 top-0 h-full flex items-center justify-between sm:max-md:pe-5 lg:pe-6 pe-4 '>
